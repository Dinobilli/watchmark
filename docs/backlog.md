...
## 3. Build Korean public notice fixtures

Labels: `template`, `good first issue`

Add anonymized fixtures for notice title, deadline, attachment, department, and application-period changes.

## 4. Build shopping product-page fixtures
